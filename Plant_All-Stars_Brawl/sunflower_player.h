...
public:
	...
	void on_attack()
	{
		...
		bullet_position.x = position.x + (size.x - bullet_size.x);
...
private:
	Animation animation_attack_ex_left;			// 龙日葵朝向左的特殊攻击动画图集
	Animation animation_attack_ex_right;		// 龙日葵朝向右的特殊攻击动画图集
